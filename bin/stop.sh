...
APP_DIR="/home/jetson/cmcc_voice_bot/bin"
BUILD_DIR="/home/jetson/cmcc_voice_bot/build/src"
...
# 仅将以下两个可执行文件视为目标进程：
# 1) /home/jetson/cmcc_voice_bot/bin/robot_avvtn
# 2) /home/jetson/cmcc_voice_bot/build/src/robot_avvtn
is_target_process() {
    local pid="$1"
    local exe_path
